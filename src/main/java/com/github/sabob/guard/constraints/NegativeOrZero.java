 ...
 */
public class NegativeOrZero implements Constraint {

    protected static final String messageTemplate = GuardUtils.getProperties().getProperty( "negative.or.zero.message" );
    ...
    public boolean isValid( Object value ) {
        ...
        boolean valid = NumberUtils.isNegativeOrZero( numberValue );
        return valid;
    }
}
